                        ...
                        ?>
                            <tr>
                                ...
                                <td width=100 class="text-center">
                                    <a class="btn btn-xs btn-warning <?php if ($d->status == 3) { ?> disabled <?php } ?>" href="<?= site_url('C_npd/nota_npd/' . $d->id_npd) ?>">
                                        <i class="fas fa-print"></i>
                                    </a>
                                    <a class="btn btn-xs btn-success <?php if ($d->status == 1 or $d->status == 2 or $d->status == 4) { ?> disabled <?php } ?>" href="<?= site_url('C_npd/edit_npd/' . $d->id_npd) ?>">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a class="btn btn-xs btn-danger <?php if ($d->status == 2 or $d->status == 4) { ?> disabled <?php } ?>" href="javascript:void(0)" onclick="hapus('<?= $d->id_npd ?>')">
