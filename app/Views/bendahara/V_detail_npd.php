...
<div class="col-md-12">
    <div class="card card-primary card-outline">
        <div class="card-header">
            <a href="<?= site_url('C_bendahara/npd') ?>" class="btn btn-info btn-flat">
        ...
        <div class="invoice col-sm-12 p-3 mb-3">
            ...
            <div class="row no-print">
                <div class="col-12">
                    ...
                    <a href="<?= base_url('C_bendahara/cairkan_npd/ ' . $data_npd->id_npd)  ?>" class="btn btn-success float-right <?php if ($data_npd->status == 3 || $data_npd->status == 4 || $data_npd->status == 1) { ?> disabled <?php } ?>"><i class="fas fa-check-circle"></i>
                        Cairkan NPD
                    </a>
                </div>
            </div>
